...
const { produtos, PainelVendas } = require("../../databases")
    ...
    run: async (interaction, client) => {
        ...
        if (interaction.type == InteractionType.ModalSubmit) {
            ...
            if (interaction.customId === 'changesequenciaprodutos') {
                ...
                if (!PainelVendas.get(`${t.painel}.produtos`).includes(idproduto)) return interaction.reply({ content: `${obterEmoji(22)} | Error: O produto não está cadastrado nesse painel!` }).then(m => {
                ...
                var produtos2 = PainelVendas.get(`${t.painel}.produtos`)
                ...
                PainelVendas.set(`${t.painel}.produtos`, produtos2)
            ...
            if (interaction.customId === 'editpainelcolor') {
                ...
                if (isHexadecimal) {
                    ...
                    PainelVendas.set(`${t.painel}.settings.color`, editpainelcolor)
            ...
            if (interaction.customId === 'editpainelBanner') {
                ...
                if (url.test(editpainelBanner)) {
                    ...
                    PainelVendas.set(`${t.painel}.settings.banner`, editpainelBanner)
                    configembedpainel(interaction, client)
                } else {
            ...
            if (interaction.customId === 'editpainelMiniatura') {
                ...
                if (url.test(editpainelMiniatura)) {
                    ...
                    PainelVendas.set(`${t.painel}.settings.miniatura`, editpainelMiniatura)
                    configembedpainel(interaction, client)
                } else {
        ...
        if (interaction.isButton()) {
            ...
            if (interaction.customId.startsWith('deletarpainel')) {
                ...
                var sasassasa  = PainelVendas.get(t.painel)

                try {
                    const channel = await client.channels.fetch(sasassasa.ChannelID);
                    await channel.messages.delete(sasassasa.MessageID).catch(error => null );
                } catch (error) { console.log(error) }

                PainelVendas.delete(t.painel)
            ...
            if (interaction.customId.startsWith('removeprodutopainel')) {
                ...
                interaction.message.edit({ embeds: [embed], components: [] }).then(msg => {
                    ...
                    collector.on('collect', async (message) => {
                        ...
                        if (produtos.get(`${message.content}_${interaction.guild.id}`) == null) return interaction.reply({ content: `${obterEmoji(22)} | Error: Produto Inexistente!` }).then(m => {
                            configprodutospainel(interaction, client)
                            setTimeout(() => {
                                m.delete()
                            }, 2000);
                        ...
                        if (!PainelVendas.get(`${t.painel}.produtos`).includes(message.content)) return interaction.reply({ content: `${obterEmoji(22)} | Error: O produto não está cadastrado nesse painel!` }).then(m => {
                            configprodutospainel(interaction, client)
                            setTimeout(() => {
                                m.delete()
                            }, 2000);
                        ...
                        PainelVendas.pull(`${t.painel}.produtos`, (element, index, array) => element.uuuuuuu)
                        configprodutospainel(interaction, client)
            ...
            if (interaction.customId.startsWith('addprodutopainel')) {
                ...
                interaction.message.edit({ embeds: [embed], components: [] }).then(msg => {
                    ...
                    collector.on('collect', async (message) => {
                        ...
                        if (produtos.get(`${message.content}_${interaction.guild.id}`) == null) return interaction.channel.send({ content: `${obterEmoji(22)} | Error: Produto Inexistente!` }).then(m => {
                            configprodutospainel(interaction, client)
                            setTimeout(() => {
                                m.delete()
                            }, 2000);
                        ...
                        if (PainelVendas.get(`${t.painel}.produtos`).includes(message.content)) return interaction.channel.send({ content: `${obterEmoji(22)} | Error: Este Produto Já Existe nesse Painel!` }).then(m => {
                            configprodutospainel(interaction, client)
                            setTimeout(() => {
                                m.delete()
                            }, 2000);
                        ...
                        PainelVendas.push(`${t.painel}.produtos`, message.content)
...
${PainelVendas.get(`${t.painel}.settings.title`)}
Envie o novo título abaixo:\n\nCaso queira cancelar escreva abaixo **cancelar**`)
                ...
                interaction.message.edit({ embeds: [embed], components: [] }).then(msg => {
                    ...
                    collector.on('collect', async (message) => {
                        ...
                        PainelVendas.set(`${t.painel}.settings.title`, message.content)
...
Envie a nova descrição abaixo:\n\nCaso queira cancelar escreva abaixo **cancelar**`)
                ...
                interaction.message.edit({ embeds: [embed], components: [] }).then(msg => {
                    ...
                    collector.on('collect', async (message) => {
                        ...
                        PainelVendas.set(`${t.painel}.settings.desc`, message.content)
...
${PainelVendas.get(`${t.painel}.settings.rodape`) == null ? 'Sem Rodapé' : PainelVendas.get(`${t.painel}.settings.rodape`)}
Envie o novo rodapé abaixo:\n\nCaso queira cancelar escreva abaixo **cancelar**`)
                ...
                interaction.message.edit({ embeds: [embed], components: [] }).then(msg => {
                    ...
                    collector.on('collect', async (message) => {
                        ...
                        PainelVendas.set(`${t.painel}.settings.rodape`, message.content)
            ...
            if (interaction.customId.startsWith('editpainelplaceholder')) {
                ...
                .setColor(General.get(`ConfigGeral.ColorEmbed`) == '#635b44' ? 'Random' : `${General.get(`ConfigGeral.ColorEmbed`)}`)
                    .setTitle(`${client.user.username} | Gerenciar Painel`)
                    .setDescription(`**Rodapé Atual:**\n${PainelVendas.get(`${t.painel}.settings.placeholder`) == null ? '\`Envie o novo Texto abaixo:\`' : PainelVendas.get(`${t.painel}.settings.placeholder`)}\nEnvie o novo Texto abaixo:\n\nCaso queira cancelar escreva abaixo **cancelar**`)
                ...
                interaction.message.edit({ embeds: [embed], components: [] }).then(msg => {
                    ...
                    collector.on('collect', async (message) => {
                        ...
                        PainelVendas.set(`${t.painel}.settings.placeholder`, message.content)
        ...
        if (interaction.isAutocomplete()) {
            if (interaction.commandName == 'criarpainel') {
                ...
                var produtosFiltrados = produtos.filter(x => x.data.ID?.toLowerCase().includes(nomeDigitado));
            ...
            if (interaction.commandName == 'config_painel') {
                const teste = PainelVendas.fetchAll()
            ...
            if (interaction.commandName == 'set_painel') {
                var teste = PainelVendas.fetchAll()

                var nomeDigitado = interaction.options.getFocused().toLowerCase();
                var produtosFiltrados = PainelVendas.filter(x => x.data.ID?.toLowerCase().includes(nomeDigitado));
                var produtosSelecionados = produtosFiltrados.slice(0, 25);
             ...
             interaction.deferUpdate()
                ...
                interaction.message.edit({ embeds: [embed], components: [] }).then(msg => {
                    ...
                    collector.on('collect', async (message) => {
                        ...
                        produtos.set(`${interaction.values[0]}.painel.emoji`, message.content)
                        configprodutospainel(interaction, client)
